...
class ConditionalPositionalEncoding(nn.Sequential):
    def __init__(self, channels):
        super().__init__()
        self.add_module('conditional_ositional_encoding',
...
def EdgeViT_XXS(pretrained=False, num_classes=10):
    model = EdgeViT(**edgevit_configs['XXS'], num_classes=num_classes)
